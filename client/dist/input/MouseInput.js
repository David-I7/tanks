...
export class MouseGestures {
    mouse;
    lastMouseDownBeforeRelease = null;
    lastMouseReleaseBeforeDown = null;
    lastClickTime = null;
    isDragging = false;
    isMouseDown = false;
    isMouseUp = false;
    ...
    dragEnd = null;
    dragMoves = [];
    lastDragMoveBeforeDragEnd = null;
    MAX_CLICK_DURATION = 200;
    MAX_CLICK_DISTANCE_SQ = 25;
    DOUBLE_CLICK_DELAY = 300;
    MIN_DRAG_START_DISTANCE_SQ = 25;
    constructor(mouse) {
        this.mouse = mouse;
    }
    update() {
        ...
        for (const e of ups) {
            ...
            if (this.lastMouseDownBeforeRelease) {
                ...
                const dy = e.y - this.lastMouseDownBeforeRelease.y;
                const distSq = dx * dx + dy * dy;
                if (duration <= this.MAX_CLICK_DURATION &&
